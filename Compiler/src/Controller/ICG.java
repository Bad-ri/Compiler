...
public class ICG {
   ...
   Pattern pattern1 = Pattern.compile("(id\\d)[+|-](\\d)[*|\\\\]", Pattern.CASE_INSENSITIVE);
        ...
        while(matcher.find()) {
           ...
           if(matcher.find()) {
               if(last.equals("3.14")){}
                          ...
                          Result += "             T0= int to float(" + last + ")"+" \n "; 
               }
           }    //id2-5\5   
           Result += "             T1= int to float(" + lex.substring(3,4) + ")"+" \n ";
           Result += "             T2=#T1 "+ lex.substring(5,6) + lex.substring(6)+" \n ";
           Result += "             T3=T2"+lex.substring(3,4) + lex.substring(0, 3)+" \n ";
           Result += "             Id1=T3";
           return Result;     
        }         
        //id2-3.14\4
        ...
        matcher = pattern2.matcher(lex);  
           ...
           Result += "             T1="+last+ lex.substring(8,9) + lex.substring(4,8)+" \n ";
           Result += "             T2=T1"+lex.substring(3,4) + lex.substring(0, 3)+" \n ";
           Result += "             Id1=T2";
           return Result;     
        }     
         //id2-id3*5
      ...
      Pattern pattern3 = Pattern.compile("(id\\d)[+|-](id\\d)[*|\\\\]", Pattern.CASE_INSENSITIVE);
        matcher = pattern3.matcher(lex);
           ...
           Result += "             T1="+last+ lex.substring(7,8) + lex.substring(4,7)+" \n ";
           Result += "             T2=T1"+lex.substring(3,4) + lex.substring(0, 3)+" \n ";
           Result += "             Id1=T2";
           return Result;     
        }  
        ...
        matcher = pattern4.matcher(lex2);
           ...
           Result += "             T1= int to float(" + lex.substring(0,1) + ")"+" \n ";
           Result += "             T2= int to float(" + lex.substring(2,3) + ")"+" \n ";
           Result += "             T3="+lex.substring(2,3)+ lex.substring(3,4) + last+" \n ";
           Result += "             T4=T3"+lex.substring(1,2) + lex.substring(0, 1)+" \n ";
           Result += "             Id1=T4";
           return Result;     
        }  
        //2-3.14\5
